...
public class Constants {
	...
	// for Mutli-Thread
	public static final int REMAP_THREAD_CONUT = 1; // 用于 Buffer ReMap 的线程池 TODO 待测
	public static final int WRITE_MESSAGE_THREAD_CONUT = 1; // 用于 Buffer ReMap 的线程池 TODO 待测
